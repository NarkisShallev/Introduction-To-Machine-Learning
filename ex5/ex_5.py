...
class convolutionNet(nn.Module):
    def __init__(self, num_of_input_layers, num_of_output_layers, filter_size, stride, padding, pooling_size,
        ...
        fc1_input_size = after_pooling_input_height * after_pooling_input_width * num_of_output_layers[
            num_of_model_layers - 1]  # fc1_input_size=40X25X20=20000

        self.fc1 = nn.Linear(fc1_input_size, 5000)
        self.fc2 = nn.Linear(5000, num_of_classes)
...
def main():
    ...
    num_of_input_layers = [1, 20]
    num_of_output_layers = [20, 20]
    filter_size = 5
    stride = 1
